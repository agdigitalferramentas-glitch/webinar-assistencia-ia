...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Descubra o método usado por assistências técnicas para sair do improviso e gerar orçamentos com consistência, usando IA treinada para o seu nicho." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Webinar - Transforme o Instagram da sua assistência técnica" },
      { property: "og:description", content: "Descubra o método usado por assistências técnicas para sair do improviso e gerar orçamentos com consistência, usando IA treinada para o seu nicho." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Webinar - Transforme o Instagram da sua assistência técnica" },
      { name: "twitter:description", content: "Descubra o método usado por assistências técnicas para sair do improviso e gerar orçamentos com consistência, usando IA treinada para o seu nicho." },
